...
begin
  MessageDlgCenter('PDF-Dateien erzeugen, miteinander verbinden, drucken, Seiten entnehmen, Bilder extrahieren, verschlüsseln'
    ...
    + #13 + '15: Schnelle Anzeige der PS/PDF-Dateien im FreePDF64-Hauptprogramm'
    + #13 + '16: Komprimierung der PDF-Datei(en)'
    ...
    + #13 + '19: Bilder extrahieren aus PDF-Dateien'
...
//                  ShowMessage('Error renaming file!');
        ...
        if (Einstellungen_Form.AuswahlRG.ItemIndex = 0) or
          ...
          Ziel := (BackSlash(z) + ChangeFileExt(ExtractFileName(AP3),
            '_%03d.bmp'))
